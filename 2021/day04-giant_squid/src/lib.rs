...
//! boards on which it appears. (Numbers may not appear on all boards.) If all
//! numbers in any row or any column of a board are marked, that board *wins*.
...
//! sum of unmarked numbers equal to `148` for a final score of `148 * 13 =
//! *1924*`.
//!
