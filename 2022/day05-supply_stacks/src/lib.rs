...
//! crate `N` is on top.
//! Stack 2 contains three crates; from bottom to top, they are crates `M`, `C`,
...
//! to a different stack. In the first step of the above rearrangement
//! procedure, one crate is moved from stack 2 to stack 1, resulting in this
//! configuration:
//!
//! ```
//! [D]
